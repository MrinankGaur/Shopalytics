...
import { Store, Link2, ShoppingCart } from 'lucide-react';
    ...
    return (
        <div className="flex items-center justify-center h-full">
            <div className="text-center p-12 bg-white rounded-lg shadow-md border max-w-2xl mx-auto">
                ...
                <h2 className="mt-6 text-2xl font-bold text-gray-800">Welcome to Shopalytics!</h2>
                    ...
                    <div className="flex items-start">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="mt-1 text-gray-500">
                                Click the <button onClick={openAddStoreModal} className="font-semibold text-indigo-600 hover:underline">Add Store</button> button in the header and enter your shop's `.myshopify.com` URL.
                            </p>
                        </div>
                    </div>
                    <div className="flex items-start">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="mt-1 text-gray-500">
                                You'll be redirected to Shopify to approve the installation. After you return to the dashboard, a blue notification bar will appear. Click the **"Link to Account"** button to finalize the connection.
                            </p>
                        </div>
                    </div>
                </div>
